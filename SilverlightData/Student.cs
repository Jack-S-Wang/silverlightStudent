...
{
    public class Student : NCS.View.EntityViewBase
    {
        public event EventHandler onChange;
        private bool _IsCheck;
        [Display(Name = "选择")]
        [DataGridColumnSetup(Frozen =true,IgnoreEditTemplate =true)]
        [AutoGenerateBehavior(DataFormExVisibility = Visibility.Collapsed)]
        public bool IsCheck
        {
            get { return _IsCheck; }
            set
        ...
        [Display(Name = "审核人")]
        [AutoGenerateBehavior(DataFormExVisibility = Visibility.Collapsed,DataFormExEnabled =false)]
        ...
        //[Display(Name = "审核状态")]
        //[AutoGenerateBehavior(DataFormExVisibility = Visibility.Collapsed, DataFormExEnabled = false)]
        //[DataGridColumnSetup(Frozen = false)]
